...
import product.serializers as product_serializer
...
#         location_list = get_object_or_404(
#             product_models.Warehouse, id=self.request.user.branch.id)
#         data = product_serializer.warehouseListSerilizer(
#             location_list, many=True)
#         # print(model_to_dict(location_list))
#         # data = list(location_list.children.values())
#         # print(data)
#         query_set = queryset.filter(
#             branch__id=self.request.user.branch.id)
#         return query_set
...
#         # employee = serializer.save(user_role=user_role, branch=branch)
#         employee = serializer.save(user_role=user_role)
#         group = Group.objects.get(name=user_role.name)
...
#         branch = request.data.get("branch")
#         branch = get_object_or_404(product_models.Warehouse, id=branch)
#         old_group = Group.objects.get(name=employee.user_role.name)
#         old_group.user_set.remove(employee)
#         group = Group.objects.get(name=new_user_role.name)
#         group.user_set.add(employee)
#         serializer = serializers.EmployeeSerializer(
...
class ContactFilter(django_filters.FilterSet):
    ...
    class Meta:
        ...
        fields = ['name', 'email', 'phone', 'Type', 'keyward', 'role']
